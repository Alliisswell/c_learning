...
const int BLOCK_WIDTH = WIDTH / (BLOCK_XY);//x轴小方格数量
const int BLOCK_HEIGHT = HEIGHT / (BLOCK_XY);//y轴小方格数量

#define kongqi COLORREF RGB(200,200,200)//空气颜色，灰色
#define qiangbi COLORREF RGB(50,50,50)//墙壁颜色，黑色
#define daixuan COLORREF RGB(0,255,0)//待选颜色，绿色
#define xuanzhong COLORREF RGB(255,0,0)//选中颜色，红色
